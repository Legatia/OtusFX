...
export default function LendPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            >
                <div>
                    <h1 className="text-2xl font-bold text-white">Lending Pool</h1>
                    <p className="text-secondary">Deposit USDC to earn yield from leveraged traders</p>
                </div>
                    ...
                    <div className="flex gap-2 mb-6">
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-medium transition-all ${activeTab === "deposit"
                                ...
                                : "bg-background text-secondary hover:text-white border border-transparent"
                                }`}
                        >
                        ...
                        <div className="p-4 rounded-xl bg-background border border-white/5">
                            ...
                            <div className="flex items-center gap-4">
                                <input
                                    ...
                                    placeholder="0.00"
                                    className="flex-1 bg-transparent text-3xl font-bold text-white outline-none placeholder:text-secondary/50"
                                />
                ...
                <div className="space-y-6">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="font-semibold text-white">Risk Protection</h3>
                        </div>
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-white font-medium">Insurance Fund</span>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <h3 className="font-semibold text-white mb-3">Your Yield Sources</h3>
